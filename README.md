...
- **Copy & Paste:** No complex installation—just copy the code you need.
...
Visit the [Documentation](https://obsidianui.dev/docs/installation) to learn how to use individual components.
